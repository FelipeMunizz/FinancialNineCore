...
builder.Services.AddSingleton<InterfaceLancamento, RepositorioLancamento>();
...
builder.Services.AddSingleton<ILancamentoServico, LancamentoServico>();
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(option =>
                {
                    option.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        ValidIssuer = "FinacialCore.Security.Bearer",
                        ValidAudience = "FinacialCore.Security.Bearer",
                        IssuerSigningKey = JwtSecurityKey.Create("FinalcialCore_Secret_Key-20232004")
                    };
